...
data class GeneriskIdSomString(@Size(min = 1, max = 20) val id: String): GeneriskId {
...
val GeneriskId.somUUID get(): UUID = when (this) {
    is GeneriskIdSomString -> UUID.nameUUIDFromBytes(this.id.toByteArray()) // TODO denne genererer en versjon 3-UUID. Bør generere versjon 5
    is GeneriskIdSomUUID -> this.id
}

val GeneriskId.somString get(): String = when (this) {
